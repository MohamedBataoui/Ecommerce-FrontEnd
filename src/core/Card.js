      ...
      <div className="card bg-dark text-white mb-2 px-2">
        ...
        <div className="card-body">
          ...
          <div className="text-center my-3">
            <span style={{ fontSize: "20px" }} className="badge badge-info">
              {product.price} Dhs
            </span>
            <span className="ml-5 badge-pill badge-light text-dark">
          ...
          <div className="well">
            ...
            <span>Ajouté {moment(product.createdAt).fromNow(true)}</span>
          </div>
